...
impl TokenPricing {
    ...
    pub fn cost_split(&self, input: u64, output: u64, cache_read: u64, cache_create: u64) -> (f64, f64) {
        let in_cost = (input as f64 * self.input
            + cache_read as f64 * self.cache_read
            + cache_create as f64 * self.cache_create) / 1_000_000.0;
...
pub const FALLBACK_PROFILE: ModelProfile = ModelProfile {
    ...
    energy: EnergyCoefficients { j_per_output_tok: 0.9, input_energy_factor: 0.05 },
    pricing: TokenPricing { input: 3.0, output: 15.0, cache_read: 0.30, cache_create: 3.75 },
...
static BUILTIN_PROFILES: &[ModelProfile] = &[
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 5.0, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 5.0, output: 25.0, cache_read: 0.50, cache_create: 6.25 },
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Large,
        energy: EnergyCoefficients { j_per_output_tok: 5.0, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 15.0, output: 75.0, cache_read: 1.50, cache_create: 18.75 },
        context_window: 200_000,
        active_params_b: 200.0,
    },
    ModelProfile {
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 1.0, output: 5.0, cache_read: 0.10, cache_create: 1.25 },
        context_window: 200_000,
        active_params_b: 8.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.80, output: 4.0, cache_read: 0.08, cache_create: 1.0 },
        context_window: 200_000,
        active_params_b: 8.0,
    },
    // -----------------------------------------------------------------------
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.15, output: 0.60, cache_read: 0.075, cache_create: 0.15 },
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 0.6, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 2.50, output: 10.0, cache_read: 1.25, cache_create: 2.50 },
        context_window: 128_000,
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 1.10, output: 4.40, cache_read: 0.55, cache_create: 1.10 },
        context_window: 200_000,
        active_params_b: 8.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Large,
        energy: EnergyCoefficients { j_per_output_tok: 5.0, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 10.0, output: 40.0, cache_read: 2.50, cache_create: 10.0 },
        context_window: 200_000,
        active_params_b: 200.0,
    },
    ModelProfile {
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 0.5, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.27, output: 1.10, cache_read: 0.07, cache_create: 0.27 },
        context_window: 128_000,
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Medium,
        energy: EnergyCoefficients { j_per_output_tok: 0.5, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.55, output: 2.19, cache_read: 0.14, cache_create: 0.55 },
        context_window: 128_000,
        active_params_b: 37.0,
    },
    // -----------------------------------------------------------------------
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 3.0, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 2.0, output: 8.0, cache_read: 0.50, cache_create: 2.0 },
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Medium,
        energy: EnergyCoefficients { j_per_output_tok: 0.9, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 1.0, output: 4.0, cache_read: 0.25, cache_create: 1.0 },
        context_window: 131_072,
        active_params_b: 70.0,
    },
    // -----------------------------------------------------------------------
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Large,
        energy: EnergyCoefficients { j_per_output_tok: 3.0, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 1.25, output: 10.0, cache_read: 0.31, cache_create: 1.25 },
        context_window: 1_000_000,
        active_params_b: 100.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.15, output: 0.60, cache_read: 0.04, cache_create: 0.15 },
        context_window: 1_000_000,
        active_params_b: 8.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.10, output: 0.40, cache_read: 0.025, cache_create: 0.10 },
        context_window: 1_000_000,
        active_params_b: 8.0,
    },
    // -----------------------------------------------------------------------
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 0.3, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.27, output: 0.85, cache_read: 0.07, cache_create: 0.27 },
        context_window: 1_000_000,
    ...
    ModelProfile {
        ...
        // 109B MoE, ~17B active.
        energy: EnergyCoefficients { j_per_output_tok: 0.3, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.18, output: 0.59, cache_read: 0.05, cache_create: 0.18 },
    ...
    ModelProfile {
        ...
        energy: EnergyCoefficients { j_per_output_tok: 0.9, input_energy_factor: 0.05 },
        // Together AI pricing
        pricing: TokenPricing { input: 0.88, output: 0.88, cache_read: 0.22, cache_create: 0.88 },
        context_window: 131_072,
        active_params_b: 70.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.15, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.18, output: 0.18, cache_read: 0.05, cache_create: 0.18 },
        context_window: 131_072,
        active_params_b: 8.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Large,
        energy: EnergyCoefficients { j_per_output_tok: 5.0, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 3.50, output: 3.50, cache_read: 0.88, cache_create: 3.50 },
        context_window: 131_072,
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Medium,
        energy: EnergyCoefficients { j_per_output_tok: 0.9, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 2.0, output: 6.0, cache_read: 0.50, cache_create: 2.0 },
        context_window: 128_000,
        active_params_b: 70.0,
    },
    ModelProfile {
        ...
        energy_tier: EnergyTier::Small,
        energy: EnergyCoefficients { j_per_output_tok: 0.3, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.30, output: 0.90, cache_read: 0.08, cache_create: 0.30 },
    ...
    ModelProfile {
        ...
        energy_tier: EnergyTier::Medium,
        energy: EnergyCoefficients { j_per_output_tok: 0.9, input_energy_factor: 0.05 },
        pricing: TokenPricing { input: 0.90, output: 0.90, cache_read: 0.22, cache_create: 0.90 },
        context_window: 131_072,
